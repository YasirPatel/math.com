...
option1.addEventListener("click",() =>{
    if(!(submit_clicked)){
        option2.style.backgroundColor = "skyblue";
        option3.style.backgroundColor = "skyblue";
        option4.style.backgroundColor = "skyblue";
...
option2.addEventListener("click",() =>{
    if(!(submit_clicked)){
        option1.style.backgroundColor = "skyblue";
        option3.style.backgroundColor = "skyblue";
        option4.style.backgroundColor = "skyblue";
...
function reset_buttons(){
    option2.style.backgroundColor = "royalblue";
    option3.style.backgroundColor = "royalblue";
    option4.style.backgroundColor = "royalblue";
    option1.style.background = "royalblue";
}
...
function showScore(){
    ...
    question.textContent = `You scored ${score} out of 10`;
